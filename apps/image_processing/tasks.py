...
def create_thumbnail(image_id):
    try:
        image_instance = UploadedImage.objects.get(id=image_id)  # noqa: E501
        print(f"Iniciando processamento da imagem: {image_instance.original_image.name}")  # noqa: E501
        time.sleep(1)
        ...
        image_instance.save()
        print(f"✅ Imagens geradas para {image_instance.original_image.name}")  # noqa: E501
