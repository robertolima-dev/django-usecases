...
class BookTestCase(TestCase):
    def setUp(self):
        ...
        self.book = Book.objects.create(title="Aprendendo Django", author=self.user)  # noqa: E501
        self.book.tags.add(self.tag1, self.tag2)

        self.comment = Comment.objects.create(book=self.book, content="Excelente livro!")  # noqa: E501
...
class CommentModelTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username="ana", password="123456")  # noqa: E501
        self.book = Book.objects.create(title="Python 101", author=self.user)  # noqa: E501
        self.comment = Comment.objects.create(book=self.book, content="Excelente leitura!")  # noqa: E501
...
class BookAPITestCase(TestCase):
    def setUp(self):
        ...
        self.client.force_authenticate(user=self.user)
        self.book = Book.objects.create(title="REST com Django", author=self.user)  # noqa: E501
