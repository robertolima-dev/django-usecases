...
class Notification(BaseModel):
    ...
    obj_code = models.CharField(max_length=50, default="platform", db_index=True)   # noqa: E501
...
class UserNotificationRead(BaseModel):
    ...
    notification = models.ForeignKey(Notification, on_delete=models.SET_NULL, null=True, db_index=True)  # noqa: E501
